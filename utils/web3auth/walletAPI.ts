...
export const getAddressesFromKeys = (paymentKey: C.PrivateKey, stakeKey: C.PrivateKey, network: Network) => {
    ...
    //const paymentKeyHash = C.Ed25519KeyHash.from_bech32('5820b0c9690eefd7974191950531a0e453a54b01afd068446016a8ea3831f94ee994') // paymentKey.to_public().hash();
    //const stakeKeyHash = C.Ed25519KeyHash.from_bech32('582019e3715679043f383dd5bcdacc6d4bea4d9090addf57d97f68a53c87141fa115') //stakeKey.to_public().hash();
